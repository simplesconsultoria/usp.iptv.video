...
from usp.iptv.video.interfaces import IBrowserLayer
from usp.iptv.video.testing import FUNCTIONAL_TESTING
...
class TestInstall(BaseTestCase):
    ...
    def test_static_resource_grokker(self):
        ...
        browser.open('%s/++resource++usp.iptv.video' % portal_url)
